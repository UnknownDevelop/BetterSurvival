...
public class BlockHTFurnace extends BlockContainer 
{
	...
	public BlockHTFurnace(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDHTFurnace, world, x, y, z);
		}
	...
	{
		this.blockIcon = r.registerIcon("bettersurvival:ht_furnace_sides");
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "ht_furnace" : "ht_furnace_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockHTFurnaceIdle);
    }
	...
	public static void updateHTFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockHTFurnace);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockHTFurnaceIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int oldMetadata)
	{
		if(!keepInventory)
		{
			TileEntityHTFurnace tileEntity = (TileEntityHTFurnace)world.getTileEntity(x, y, z);
