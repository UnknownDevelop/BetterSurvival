...
public class BlockDiamondFurnace extends BlockContainer 
{
	...
	public BlockDiamondFurnace(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDDiamondFurnace, world, x, y, z);
		}
	...
	{
		this.blockIcon = r.registerIcon("bettersurvival:diamond_furnace_sides");
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "diamond_furnace" : "diamond_furnace_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockDiamondFurnaceIdle);
    }
	...
	public static void updateDiamondFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockDiamondFurnace);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockDiamondFurnaceIdle);
		}
