...
public class BlockTransparentCable extends BlockFacadeableContainer
{
	float pixel = 1F/16F;
	
	public BlockTransparentCable() 
	{
		super(Material.ground);
		
		setBlockName("cable_transparent");
	...
	{
		TileEntityTransparentCable cable = (TileEntityTransparentCable) world.getTileEntity(x, y, z);
	...
	{
		return new TileEntityTransparentCable();
	}
	...
	{
		return ((TileEntityTransparentCable)world.getTileEntity(x, y, z)).calculateRedstoneComparatorOutput();
	}
