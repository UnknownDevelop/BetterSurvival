...
public class BlockIndustrialFurnace extends BlockContainer 
{
	...
	public BlockIndustrialFurnace(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDIndustrialFurnace, world, x, y, z);
		}
	...
	public void registerBlockIcons(IIconRegister r)
	{
		...
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "industrial_furnace" : "industrial_furnace_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockIndustrialFurnaceIdle);
    }
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemstack)
    {
    	...
    	{
    		((TileEntityIndustrialFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
    	}
    }

	public static void updateIndustrialFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockIndustrialFurnace);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockIndustrialFurnaceIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int oldMetadata)
	{
		if(!keepInventory)
		{
			TileEntityIndustrialFurnace tileEntity = (TileEntityIndustrialFurnace)world.getTileEntity(x, y, z);
