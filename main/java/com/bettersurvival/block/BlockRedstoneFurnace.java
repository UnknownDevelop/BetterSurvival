...
public class BlockRedstoneFurnace extends BlockContainer 
{
	...
	public BlockRedstoneFurnace(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			...
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDRedstoneFurnace, world, x, y, z);
		}
	...
	public void registerBlockIcons(IIconRegister r)
	{
		...
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "electric_furnace" : "electric_furnace_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockRedstoneFurnaceIdle);
    }
	...
	public static void updateRedstoneFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockRedstoneFurnace);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockRedstoneFurnaceIdle);
		}
