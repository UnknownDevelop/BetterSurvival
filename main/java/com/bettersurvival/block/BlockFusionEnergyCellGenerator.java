...
public class BlockFusionEnergyCellGenerator extends BlockContainer 
{
	...
	public BlockFusionEnergyCellGenerator(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			...
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDFusionEnergyCellGenerator, world, x, y, z);
		}
	...
	{
		return new TileEntityFusionEnergyCellGenerator();
	}
	...
	public void registerBlockIcons(IIconRegister r)
	{
		...
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "fusion_energy_cell_generator" : "fusion_energy_cell_generator_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockFusionEnergyCellGeneratorIdle);
    }
	...
	public static void updateFusionCellGeneratorBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockFusionEnergyCellGenerator);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockFusionEnergyCellGeneratorIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int oldMetadata)
	{
		if(!keepInventory)
		{
			TileEntityFusionEnergyCellGenerator tileEntity = (TileEntityFusionEnergyCellGenerator)world.getTileEntity(x, y, z);
