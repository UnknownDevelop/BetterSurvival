...
public class BlockCoalGenerator extends BlockContainer
{
	...
	public BlockCoalGenerator(boolean active) 
	{
		super(Material.iron);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			if(player.isSneaking())
    		{
    			if(player.getCurrentEquippedItem() != null)
    			{
	    			if(player.getCurrentEquippedItem().getItem() == BetterSurvival.itemWrench)
	    			{
						...
						EntityItem item = new EntityItem(world, x + f, y + f1, z + f2, new ItemStack(Item.getItemFromBlock(BetterSurvival.blockCoalGeneratorIdle), 1));
			...
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDCoalGenerator, world, x, y, z);
		}
	...
	public void registerBlockIcons(IIconRegister r)
	{
		...
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "coal_generator" : "coal_generator_idle"));
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemstack)
    {
    	...
    	{
    		((TileEntityCoalGenerator)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
    	}
    }

	public static void updateCoalGeneratorBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockCoalGenerator);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockCoalGeneratorIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int oldMetadata)
	{
		if(!keepInventory)
		{
			TileEntityCoalGenerator tileEntity = (TileEntityCoalGenerator)world.getTileEntity(x, y, z);
