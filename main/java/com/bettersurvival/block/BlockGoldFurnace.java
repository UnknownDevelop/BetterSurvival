...
public class BlockGoldFurnace extends BlockContainer 
{
	...
	public BlockGoldFurnace(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDGoldFurnace, world, x, y, z);
		}
	...
	{
		this.blockIcon = r.registerIcon("bettersurvival:gold_furnace_sides");
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "gold_furnace" : "gold_furnace_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockGoldFurnaceIdle);
    }
	...
	public static void updateGoldFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockGoldFurnace);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockGoldFurnaceIdle);
		}
