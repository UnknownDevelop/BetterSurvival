...
public class BlockBatteryBox extends BlockContainer
{
	...
	public BlockBatteryBox(Material p_i45386_1_) 
	{
		super(p_i45386_1_);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			...
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDBatteryBox, world, x, y, z);
		}
	...
	public void registerBlockIcons(IIconRegister r)
	{
		...
		this.iconOutput = r.registerIcon("bettersurvival:batterybox_output");
	}
	...
	{
		TileEntityBatteryBox tileEntity = (TileEntityBatteryBox)world.getTileEntity(x, y, z);
