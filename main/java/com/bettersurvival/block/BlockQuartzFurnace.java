...
public class BlockQuartzFurnace extends BlockContainer 
{
	...
	public BlockQuartzFurnace(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDQuartzFurnace, world, x, y, z);
		}
	...
	{
		this.blockIcon = r.registerIcon("bettersurvival:quartz_furnace_sides");
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "quartz_furnace" : "quartz_furnace_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockQuartzFurnaceIdle);
    }
	...
	public static void updateQuartzFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockQuartzFurnace);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockQuartzFurnaceIdle);
		}
