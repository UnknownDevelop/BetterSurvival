...
public class BlockPlasticFurnace extends BlockContainer 
{
	...
	public BlockPlasticFurnace(Material mat, boolean active) 
	{
		super(mat);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			FMLNetworkHandler.openGui(player, BetterSurvival.instance, BetterSurvival.guiIDPlasticFurnace, world, x, y, z);
		}
	...
	{
		return new TileEntityPlasticFurnace();
	}
	...
	{
		this.blockIcon = r.registerIcon("bettersurvival:plastic_furnace_sides");
		this.iconFront = r.registerIcon("bettersurvival:" + (this.isActive ? "plastic_furnace" : "plastic_furnace_idle"));
	}
    ...
    {
        return Item.getItemFromBlock(BetterSurvival.blockPlasticFurnaceIdle);
    }
	...
	public static void updatePlasticFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	{
		...
		if(active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockPlasticFurnace);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, BetterSurvival.blockPlasticFurnaceIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int oldMetadata)
	{
		if(!keepInventory)
		{
			TileEntityPlasticFurnace tileEntity = (TileEntityPlasticFurnace)world.getTileEntity(x, y, z);
