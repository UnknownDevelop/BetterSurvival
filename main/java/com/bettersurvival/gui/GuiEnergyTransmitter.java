...
public class GuiEnergyTransmitter extends GuiScreen
{
	...
	public GuiEnergyTransmitter(TileEntityEnergyTransmitter tileEntity)
	{
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		fontRendererObj.drawString(StatCollector.translateToLocal("gui.energy_transmitter"), width/2-fontRendererObj.getStringWidth(StatCollector.translateToLocal("gui.energy_transmitter"))/2, guiTop+5, 0x808080);
