...
public class ContainerGeothermalGenerator extends Container
{
	...
	public int lastLavaStored;
	
	public ContainerGeothermalGenerator(InventoryPlayer inv, TileEntityGeothermalGenerator tileentity)
	{
		this.tileentity = tileentity;
		
		this.addSlotToContainer(new Slot(tileentity, 0, 62, 38));
	...
	public void addCraftingToCrafters(ICrafting crafting)
	{
		...
		crafting.sendProgressBarUpdate(this, 3, (int) this.tileentity.lavaStored);
	}
	...
	public void detectAndSendChanges()
	{
		...
		for(int i = 0; i < this.crafters.size(); i++)
		{
			...
			if(this.lastLavaStored != this.tileentity.lavaStored)
			{
				crafting.sendProgressBarUpdate(this, 3, (int) this.tileentity.lavaStored);
			}
		}
		...
		this.lastLavaStored = (int) this.tileentity.lavaStored;
	}
	...
	public void updateProgressBar(int slot, int par2)
	{
		...
		if(slot == 3) this.tileentity.lavaStored = par2;
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int clickedSlotNumber)
	{
		...
		if(slot != null && slot.getHasStack())
		{
			...
			{
				if(TileEntityGeothermalGenerator.isItemFuel(itemStack1))
				{
