...
{
	private TileEntityDiamondFurnace tileentity;
	...
	public ContainerDiamondFurnace(InventoryPlayer inv, TileEntityDiamondFurnace tileentity)
	{
		this.tileentity = tileentity;
		
		this.addSlotToContainer(new Slot(tileentity, 0, 80, 6));
		this.addSlotToContainer(new SlotFurnace(inv.player, tileentity, 1, 56, 51));
		this.addSlotToContainer(new Slot(tileentity, 2, 80, 55));
		this.addSlotToContainer(new SlotFurnace(inv.player, tileentity, 3, 104, 51));
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int clickedSlotNumber)
	{
		...
		if(slot != null && slot.getHasStack())
		{
			...
			if(clickedSlotNumber == 1 || clickedSlotNumber == 3)
			{
			...
			else if(clickedSlotNumber != 0 && clickedSlotNumber != 1 && clickedSlotNumber != 2 && clickedSlotNumber != 3)
			{
