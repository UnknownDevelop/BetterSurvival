...
{
	private TileEntityRedstoneFurnace tileentity;
	...
	public ContainerRedstoneFurnace(InventoryPlayer inv, TileEntityRedstoneFurnace tileentity)
	{
		this.tileentity = tileentity;
		
		this.addSlotToContainer(new Slot(tileentity, 0, 56, 17));
		this.addSlotToContainer(new SlotFurnace(inv.player, tileentity, 1, 116, 35));
		this.addSlotToContainer(new SlotMachineUpgrade(tileentity, 2, 154, 7));
		this.addSlotToContainer(new SlotMachineUpgrade(tileentity, 3, 154, 25));
		this.addSlotToContainer(new SlotMachineUpgrade(tileentity, 4, 154, 43));
		this.addSlotToContainer(new SlotMachineUpgrade(tileentity, 5, 154, 61));
