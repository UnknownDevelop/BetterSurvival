...
import com.bettersurvival.gui.slot.SlotSingleItem;
...
public class ContainerBlueprintDrawer extends Container
{
	private TileEntityBlueprintDrawer tileentity;
	
	public ContainerBlueprintDrawer(InventoryPlayer inv, TileEntityBlueprintDrawer tileentity)
	{
		this.tileentity = tileentity;

		this.addSlotToContainer(new SlotSingleItem(tileentity, 0, 56, 35));
