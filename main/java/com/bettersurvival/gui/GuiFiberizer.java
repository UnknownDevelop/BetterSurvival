...
public class GuiFiberizer extends GuiContainer 
{
	public static final ResourceLocation texture = new ResourceLocation("bettersurvival:textures/gui/fiberizer.png");
	
	public TileEntityFiberizer tileentity;

	public GuiFiberizer(InventoryPlayer inventory, TileEntityFiberizer tileentity) 
	{
		super(new ContainerFiberizer(inventory, tileentity));
