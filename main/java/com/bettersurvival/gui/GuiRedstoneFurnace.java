...
{
	public static final ResourceLocation texture = new ResourceLocation("bettersurvival:textures/gui/electric_furnace.png");
	
	public TileEntityRedstoneFurnace tileentity;

	public GuiRedstoneFurnace(InventoryPlayer inventory, TileEntityRedstoneFurnace tileentity) 
	{
		super(new ContainerRedstoneFurnace(inventory, tileentity));
	...
	public void drawGuiContainerBackgroundLayer(float f, int i, int j) 
	{
        ...
        this.drawTexturedModalRect(k + 57, l + 36 + 17 - i1, 176, 17 + 17 - i1, 14, i1 + 2);
