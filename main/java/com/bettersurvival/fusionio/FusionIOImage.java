...
public class FusionIOImage extends FusionIOComponent
{
	public ResourceLocation image;
	public int color;
	public int sizeX, sizeY;
	
	public FusionIOImage(String filepath, int sizeX, int sizeY, int color)
	{
	...
	{
		return "I;" + image.toString() + ";" + sizeX + ";" + sizeY + ";" + color;
	}
}
