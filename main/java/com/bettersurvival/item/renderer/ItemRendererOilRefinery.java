...
public class ItemRendererOilRefinery implements IItemRenderer
{
	ModelOilRefinery model;
	
	ResourceLocation texture = new ResourceLocation("bettersurvival:textures/models/model_oil_refinery.png");
	
	public ItemRendererOilRefinery()
	{
