...
public class LargeCraftingTableShapedRecipes implements IRecipe
{
    ...
    public LargeCraftingTableShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public LargeCraftingTableShapedRecipes func_92100_c()
    {
