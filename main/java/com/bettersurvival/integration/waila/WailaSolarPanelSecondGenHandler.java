...
public class WailaSolarPanelSecondGenHandler implements IWailaDataProvider
{
	@Override
	...
	{
		TileEntitySolarPanelSecondGen tile = (TileEntitySolarPanelSecondGen) accessor.getTileEntity();
